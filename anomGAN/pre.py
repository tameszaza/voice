...
DEFAULT_N_MELS = 40      # Default number of Mel filters
...
def process_directory(dir_path, output_dir,
    ...
    """
    Load .wav files, chop into fixed-duration clips, preprocess,
    and save Mel-spectrogram & MFCC arrays for model consumption.
    """

    # Prepare output subfolders
    mel_out = os.path.join(output_dir, 'mel')
    mfcc_out = os.path.join(output_dir, 'mfcc')
    ...
    # Concatenate and process leftovers
    # if leftovers:

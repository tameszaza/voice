...
from model_drive import Ganomaly                                # created earlier
...
def build_parser() -> argparse.ArgumentParser:
    ...
    g_data.add_argument("--data_file", type=str, default="ResData/wavefake64_2048split/train/real.npy",
    ...
    g_data.add_argument("--isize", type=int, default=64, help="image H×W")
    g_data.add_argument("--nc",    type=int, default=1,   help="#channels")

    # ---------- model ----------
    g_model = p.add_argument_group("model")
    g_model.add_argument("--nz",          type=int, default=100, help="latent dim")
    ...
    g_misc.add_argument("--outf",   type=str, default="output_tradgan_from_local/",
    ...
    g_model.add_argument("--w_con", type=float, default=1.0,

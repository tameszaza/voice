...
def build_option_parser():
    ...
    p.add_argument("--data_root", type=str, default="ResData/wavefake64_split/")
    p.add_argument("--outf", type=str, default="./output_multigan")
    p.add_argument("--name", type=str, default="FirstTime64")
    ...
    p.add_argument("--lr", type=float, default=5*1e-5)
    ...
    #                help="Path to a pretrained discriminator (.pth).")
    p.add_argument("--resume", type=str, default="interrupt_epoch372",
